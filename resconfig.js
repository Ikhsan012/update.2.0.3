...
const config = {
    ...
    region       	: 'indonesia',
    resbot_version  : 'Ikhsan-Dev v2.0.3',
    ...
    ownername       : 'Ikhsan',
    botname         : 'IkhsanBot',
    packname        : 'By IkhsanDev',
    typeWelcome 	: '3', // ada 3 pilihan angka 1 = image pp user  2 = image welcome custom   || 3 = teks only
    author          : `Date: ${moment.tz('Asia/Makassar').format('DD/MM/YY')}\nYouTube: Ikhsan Null\nBot: 087846614391`,
    prefix_custom   : ['#','!','.'],
    sessionName     : 'session',
